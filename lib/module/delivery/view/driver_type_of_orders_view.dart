...
import 'package:branch_manager/module/delivery/cubit/type_of_order_screen_cubit/states.dart';
...
class DriverTypeOfOrdersScreen extends StatelessWidget {
  static const id = 'type_of_orders_view';

  final OrderTypeTapModel orderTypeTab;

  DriverTypeOfOrdersScreen({@required this.orderTypeTab})
  ...
  Widget build(BuildContext context) {
    ...
    _scrollController.addListener(() {
      if (_scrollController.position.pixels >=
        ...
        DriverTypeOfOrdersViewCubit.get(context).fetchMore();
      }
    });
    ...
    return AuthListener(
      child: Builder(
        builder: (context) {
          return BlocConsumer<DriverTypeOfOrdersViewCubit,
              DriverTypeOgOrderScreenStates>(
  ...
  Widget _body(BuildContext context, DriverTypeOgOrderScreenStates state) {
    final cubit = DriverTypeOfOrdersViewCubit.get(context);
